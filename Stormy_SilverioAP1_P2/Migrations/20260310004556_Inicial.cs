        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AsignacionesPuntosIdAsignacion = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleAsignaciones", x => x.IdDetalle);
                    table.ForeignKey(
                        name: "FK_DetalleAsignaciones_AsignacionesPuntos_AsignacionesPuntosIdAsignacion",
                        column: x => x.AsignacionesPuntosIdAsignacion,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleAsignaciones_AsignacionesPuntosIdAsignacion",
                table: "DetalleAsignaciones",
                column: "AsignacionesPuntosIdAsignacion");
        }
